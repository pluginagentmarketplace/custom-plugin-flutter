...
This guide provides comprehensive documentation for the **localization** skill in the custom-plugin-flutter plugin.
...
```bash
# Invoke the skill
claude "localization - [your task description]"

# Example
claude "localization - analyze the current implementation"
```
...
def implement_localization(input_data):
    """
    Implement localization functionality.
