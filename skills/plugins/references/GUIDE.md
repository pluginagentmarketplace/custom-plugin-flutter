...
This guide provides comprehensive documentation for the **plugins** skill in the custom-plugin-flutter plugin.
...
```bash
# Invoke the skill
claude "plugins - [your task description]"

# Example
claude "plugins - analyze the current implementation"
```
...
def implement_plugins(input_data):
    """
