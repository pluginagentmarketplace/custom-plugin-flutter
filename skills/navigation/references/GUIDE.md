...
This guide provides comprehensive documentation for the **navigation** skill in the custom-plugin-flutter plugin.
...
```bash
# Invoke the skill
claude "navigation - [your task description]"

# Example
claude "navigation - analyze the current implementation"
```
...
def implement_navigation(input_data):
    """
